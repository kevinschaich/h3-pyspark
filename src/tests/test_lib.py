...
class TestLib(unittest.TestCase):
    ...
    def test_geo_to_h3(self):
        ...
        expected = h3_pyspark.sanitize_types(h3.geo_to_h3(*h3_test_args))
    ...
    def test_h3_to_geo(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_to_geo(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_to_geo_boundary(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_to_geo_boundary(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_get_resolution(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_get_resolution(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_get_base_cell(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_get_base_cell(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_string_to_h3(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.string_to_h3(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_to_string(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_to_string(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_is_valid(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_is_valid(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_is_res_class_III(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_is_res_class_III(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_is_pentagon(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_is_pentagon(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_get_faces(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_get_faces(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_k_ring(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.k_ring(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_k_ring_distances(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.k_ring_distances(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_hex_range(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.hex_range(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_hex_range_distances(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.hex_range_distances(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_hex_ranges(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.hex_ranges(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_hex_ring(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.hex_ring(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_line(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_line(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_distance(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_distance(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_experimental_h3_to_local_ij(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.experimental_h3_to_local_ij(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_experimental_local_ij_to_h3(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.experimental_local_ij_to_h3(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_to_parent(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_to_parent(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_to_children(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_to_children(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_to_center_child(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_to_center_child(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_compact(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.compact(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_uncompact(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.uncompact(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_polyfill(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.polyfill(json.loads(polygon), integer, True))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_set_to_multi_polygon(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_set_to_multi_polygon(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_indexes_are_neighbors(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_indexes_are_neighbors(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_get_h3_unidirectional_edge(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.get_h3_unidirectional_edge(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_h3_unidirectional_edge_is_valid(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.h3_unidirectional_edge_is_valid(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_get_origin_h3_index_from_unidirectional_edge(self):
        ...
        actual = df.withColumn('actual', h3_pyspark.get_origin_h3_index_from_unidirectional_edge(*h3_pyspark_test_args))
        actual = actual.collect()[0]['actual']
    ...
    def test_get_destination_h3_index_from_unidirectional_edge(self):
        ...
        actual = df.withColumn('actual', h3_pyspark.get_destination_h3_index_from_unidirectional_edge(*h3_pyspark_test_args))
        actual = actual.collect()[0]['actual']
    ...
    def test_hex_area(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.hex_area(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_cell_area(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.cell_area(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_edge_length(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.edge_length(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_exact_edge_length(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.exact_edge_length(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_num_hexagons(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.num_hexagons(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_get_res0_indexes(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.get_res0_indexes(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_get_pentagon_indexes(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.get_pentagon_indexes(*h3_test_args))
        assert sort(actual) == sort(expected)
    ...
    def test_point_dist(self):
        ...
        actual = actual.collect()[0]['actual']
        expected = h3_pyspark.sanitize_types(h3.point_dist(*h3_test_args))
        assert sort(actual) == sort(expected)
